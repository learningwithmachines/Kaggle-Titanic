...
# Average CV score on the training set was:0.841376356882686
exported_pipeline = make_pipeline(
    ...
    ExtraTreesClassifier(bootstrap=True, criterion="gini", max_features=0.5, min_samples_leaf=7, min_samples_split=3, n_estimators=400)
)
