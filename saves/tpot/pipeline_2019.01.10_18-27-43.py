...
# Average CV score on the training set was:0.8413583252190847
exported_pipeline = make_pipeline(
    ...
    ExtraTreesClassifier(bootstrap=True, criterion="entropy", max_features=0.45, min_samples_leaf=7, min_samples_split=3, n_estimators=800)
)
